...
import type { PropertyKpiData } from "../types/individual-dashboard.types";

type IndividualPropertyKpisSectionProps = {
  kpis: PropertyKpiData;
};

export function IndividualPropertyKpisSection({
  kpis,
}: IndividualPropertyKpisSectionProps) {
  return (
